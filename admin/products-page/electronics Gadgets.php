...
<head>
	...
	#view-product-table .table-bordered{color: black;}
	...
	echo "<h3 style='color:white;'> No product found ! </h3>";
					...
					echo "  <tr>    
						...
						echo "<tr>  
									    ...
									    <td> <a href='#'> <img  class='img' src='../products/electronics/$img_no.jpg' height='50px' alt='No Image found'  /> </a>  </td>
...
<center>  <hr style="border:1px solid orange; width:50%">   </center>
