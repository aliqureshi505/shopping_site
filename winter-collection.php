...
<body>
   ...
   <center>  <h4> <span><img src="assets/clothes-.png" height="40px"></span> &nbsp; Winter Collection </h4> <center>
		...
		<br>
			...
			$fetch_women_fashion = "SELECT * FROM winter_clothes ORDER BY id DESC ";
			...
			<div class=" col-md-3 "> 
				 <div class="thumbnail" id="btns"> 	
				 	<h4 class="title"><?php  echo  $image_no; ?></h4>
				 			<?php  echo " <img src='admin/products/winter/{$image_no}.jpg'   alt='image-not-found' />" ?>
				 	...
				 	<a href="view-description.php?category=winter-clothes&prdt_id=<?php echo $id; ?> ">
